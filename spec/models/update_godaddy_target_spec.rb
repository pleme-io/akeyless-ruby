...
# Unit tests for Akeyless::UpdateGodaddyTarget
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::UpdateGodaddyTarget do
  let(:instance) { Akeyless::UpdateGodaddyTarget.new }

  describe 'test an instance of UpdateGodaddyTarget' do
    it 'should create an instance of UpdateGodaddyTarget' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::UpdateGodaddyTarget)
    end
  end
