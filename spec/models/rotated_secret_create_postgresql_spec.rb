...
# Unit tests for Akeyless::RotatedSecretCreatePostgresql
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::RotatedSecretCreatePostgresql do
  let(:instance) { Akeyless::RotatedSecretCreatePostgresql.new }

  describe 'test an instance of RotatedSecretCreatePostgresql' do
    it 'should create an instance of RotatedSecretCreatePostgresql' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::RotatedSecretCreatePostgresql)
    end
  end
