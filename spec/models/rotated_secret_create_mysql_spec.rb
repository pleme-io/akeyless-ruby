...
# Unit tests for Akeyless::RotatedSecretCreateMysql
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::RotatedSecretCreateMysql do
  let(:instance) { Akeyless::RotatedSecretCreateMysql.new }

  describe 'test an instance of RotatedSecretCreateMysql' do
    it 'should create an instance of RotatedSecretCreateMysql' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::RotatedSecretCreateMysql)
    end
  end
