...
# Unit tests for Akeyless::EventForwarderCreateWebhook
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::EventForwarderCreateWebhook do
  let(:instance) { Akeyless::EventForwarderCreateWebhook.new }

  describe 'test an instance of EventForwarderCreateWebhook' do
    it 'should create an instance of EventForwarderCreateWebhook' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::EventForwarderCreateWebhook)
    end
  end
