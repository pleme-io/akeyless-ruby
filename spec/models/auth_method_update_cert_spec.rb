...
# Unit tests for Akeyless::AuthMethodUpdateCert
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::AuthMethodUpdateCert do
  let(:instance) { Akeyless::AuthMethodUpdateCert.new }

  describe 'test an instance of AuthMethodUpdateCert' do
    it 'should create an instance of AuthMethodUpdateCert' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::AuthMethodUpdateCert)
    end
  end
  ...
  describe 'test attribute "allowed_cors"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
