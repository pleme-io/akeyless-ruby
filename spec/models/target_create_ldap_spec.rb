...
# Unit tests for Akeyless::TargetCreateLdap
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::TargetCreateLdap do
  let(:instance) { Akeyless::TargetCreateLdap.new }

  describe 'test an instance of TargetCreateLdap' do
    it 'should create an instance of TargetCreateLdap' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::TargetCreateLdap)
    end
  end
