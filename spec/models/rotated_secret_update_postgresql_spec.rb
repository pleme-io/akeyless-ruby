...
# Unit tests for Akeyless::RotatedSecretUpdatePostgresql
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::RotatedSecretUpdatePostgresql do
  let(:instance) { Akeyless::RotatedSecretUpdatePostgresql.new }

  describe 'test an instance of RotatedSecretUpdatePostgresql' do
    it 'should create an instance of RotatedSecretUpdatePostgresql' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::RotatedSecretUpdatePostgresql)
    end
  end
