...
# Unit tests for Akeyless::UpdateEventForwarder
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::UpdateEventForwarder do
  let(:instance) { Akeyless::UpdateEventForwarder.new }

  describe 'test an instance of UpdateEventForwarder' do
    it 'should create an instance of UpdateEventForwarder' do
      expect(instance).to be_instance_of(Akeyless::UpdateEventForwarder)
    end
  end
