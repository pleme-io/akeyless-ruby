...
# Unit tests for Akeyless::RotatedSecretUpdateRedis
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::RotatedSecretUpdateRedis do
  let(:instance) { Akeyless::RotatedSecretUpdateRedis.new }

  describe 'test an instance of RotatedSecretUpdateRedis' do
    it 'should create an instance of RotatedSecretUpdateRedis' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::RotatedSecretUpdateRedis)
    end
  end
