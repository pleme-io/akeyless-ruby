...
# Unit tests for Akeyless::RotatedSecretCreateOracledb
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::RotatedSecretCreateOracledb do
  let(:instance) { Akeyless::RotatedSecretCreateOracledb.new }

  describe 'test an instance of RotatedSecretCreateOracledb' do
    it 'should create an instance of RotatedSecretCreateOracledb' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::RotatedSecretCreateOracledb)
    end
  end
