...
# Unit tests for Akeyless::TargetUpdateLetsEncrypt
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::TargetUpdateLetsEncrypt do
  let(:instance) { Akeyless::TargetUpdateLetsEncrypt.new }

  describe 'test an instance of TargetUpdateLetsEncrypt' do
    it 'should create an instance of TargetUpdateLetsEncrypt' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::TargetUpdateLetsEncrypt)
    end
  end
