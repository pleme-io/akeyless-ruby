...
# Unit tests for Akeyless::DynamicSecretUpdatePing
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::DynamicSecretUpdatePing do
  let(:instance) { Akeyless::DynamicSecretUpdatePing.new }

  describe 'test an instance of DynamicSecretUpdatePing' do
    it 'should create an instance of DynamicSecretUpdatePing' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::DynamicSecretUpdatePing)
    end
  end
