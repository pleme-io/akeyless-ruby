...
# Unit tests for Akeyless::RotatedSecretCreateDockerhub
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::RotatedSecretCreateDockerhub do
  let(:instance) { Akeyless::RotatedSecretCreateDockerhub.new }

  describe 'test an instance of RotatedSecretCreateDockerhub' do
    it 'should create an instance of RotatedSecretCreateDockerhub' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::RotatedSecretCreateDockerhub)
    end
  end
