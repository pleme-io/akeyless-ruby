...
# Unit tests for Akeyless::AuthMethodCreateCert
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::AuthMethodCreateCert do
  let(:instance) { Akeyless::AuthMethodCreateCert.new }

  describe 'test an instance of AuthMethodCreateCert' do
    it 'should create an instance of AuthMethodCreateCert' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::AuthMethodCreateCert)
    end
  end
