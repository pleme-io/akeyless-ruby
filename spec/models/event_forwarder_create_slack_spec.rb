...
# Unit tests for Akeyless::EventForwarderCreateSlack
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::EventForwarderCreateSlack do
  let(:instance) { Akeyless::EventForwarderCreateSlack.new }

  describe 'test an instance of EventForwarderCreateSlack' do
    it 'should create an instance of EventForwarderCreateSlack' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::EventForwarderCreateSlack)
    end
  end
