...
# Unit tests for Akeyless::RotatedSecretUpdateMongodb
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::RotatedSecretUpdateMongodb do
  let(:instance) { Akeyless::RotatedSecretUpdateMongodb.new }

  describe 'test an instance of RotatedSecretUpdateMongodb' do
    it 'should create an instance of RotatedSecretUpdateMongodb' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::RotatedSecretUpdateMongodb)
    end
  end
