...
# Unit tests for Akeyless::EventForwarderCreateEmail
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::EventForwarderCreateEmail do
  let(:instance) { Akeyless::EventForwarderCreateEmail.new }

  describe 'test an instance of EventForwarderCreateEmail' do
    it 'should create an instance of EventForwarderCreateEmail' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::EventForwarderCreateEmail)
    end
  end
