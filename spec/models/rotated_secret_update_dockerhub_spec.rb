...
# Unit tests for Akeyless::RotatedSecretUpdateDockerhub
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::RotatedSecretUpdateDockerhub do
  let(:instance) { Akeyless::RotatedSecretUpdateDockerhub.new }

  describe 'test an instance of RotatedSecretUpdateDockerhub' do
    it 'should create an instance of RotatedSecretUpdateDockerhub' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::RotatedSecretUpdateDockerhub)
    end
  end
