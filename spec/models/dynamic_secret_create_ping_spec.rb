...
# Unit tests for Akeyless::DynamicSecretCreatePing
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::DynamicSecretCreatePing do
  let(:instance) { Akeyless::DynamicSecretCreatePing.new }

  describe 'test an instance of DynamicSecretCreatePing' do
    it 'should create an instance of DynamicSecretCreatePing' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::DynamicSecretCreatePing)
    end
  end
