...
# Unit tests for Akeyless::RotatedSecretUpdateCassandra
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::RotatedSecretUpdateCassandra do
  let(:instance) { Akeyless::RotatedSecretUpdateCassandra.new }

  describe 'test an instance of RotatedSecretUpdateCassandra' do
    it 'should create an instance of RotatedSecretUpdateCassandra' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::RotatedSecretUpdateCassandra)
    end
  end
