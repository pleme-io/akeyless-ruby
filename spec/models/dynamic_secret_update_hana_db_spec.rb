...
# Unit tests for Akeyless::DynamicSecretUpdateHanaDb
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::DynamicSecretUpdateHanaDb do
  let(:instance) { Akeyless::DynamicSecretUpdateHanaDb.new }

  describe 'test an instance of DynamicSecretUpdateHanaDb' do
    it 'should create an instance of DynamicSecretUpdateHanaDb' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::DynamicSecretUpdateHanaDb)
    end
  end
