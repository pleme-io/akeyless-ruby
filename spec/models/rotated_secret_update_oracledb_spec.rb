...
# Unit tests for Akeyless::RotatedSecretUpdateOracledb
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::RotatedSecretUpdateOracledb do
  let(:instance) { Akeyless::RotatedSecretUpdateOracledb.new }

  describe 'test an instance of RotatedSecretUpdateOracledb' do
    it 'should create an instance of RotatedSecretUpdateOracledb' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::RotatedSecretUpdateOracledb)
    end
  end
