...
# Unit tests for Akeyless::DynamicSecretUpdateLdap
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::DynamicSecretUpdateLdap do
  let(:instance) { Akeyless::DynamicSecretUpdateLdap.new }

  describe 'test an instance of DynamicSecretUpdateLdap' do
    it 'should create an instance of DynamicSecretUpdateLdap' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::DynamicSecretUpdateLdap)
    end
  end
