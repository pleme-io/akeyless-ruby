...
# Unit tests for Akeyless::AuthMethodUpdateOIDC
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::AuthMethodUpdateOIDC do
  let(:instance) { Akeyless::AuthMethodUpdateOIDC.new }

  describe 'test an instance of AuthMethodUpdateOIDC' do
    it 'should create an instance of AuthMethodUpdateOIDC' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::AuthMethodUpdateOIDC)
    end
  end
  ...
  describe 'test attribute "required_scopes_prefix"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
