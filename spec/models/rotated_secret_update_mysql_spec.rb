...
# Unit tests for Akeyless::RotatedSecretUpdateMysql
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::RotatedSecretUpdateMysql do
  let(:instance) { Akeyless::RotatedSecretUpdateMysql.new }

  describe 'test an instance of RotatedSecretUpdateMysql' do
    it 'should create an instance of RotatedSecretUpdateMysql' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::RotatedSecretUpdateMysql)
    end
  end
