...
# Unit tests for Akeyless::RotatedSecretUpdateAzure
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::RotatedSecretUpdateAzure do
  let(:instance) { Akeyless::RotatedSecretUpdateAzure.new }

  describe 'test an instance of RotatedSecretUpdateAzure' do
    it 'should create an instance of RotatedSecretUpdateAzure' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::RotatedSecretUpdateAzure)
    end
  end
