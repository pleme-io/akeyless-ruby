...
# Unit tests for Akeyless::TargetUpdateGlobalSign
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::TargetUpdateGlobalSign do
  let(:instance) { Akeyless::TargetUpdateGlobalSign.new }

  describe 'test an instance of TargetUpdateGlobalSign' do
    it 'should create an instance of TargetUpdateGlobalSign' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::TargetUpdateGlobalSign)
    end
  end
