...
# Unit tests for Akeyless::EventForwarderUpdateSlack
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::EventForwarderUpdateSlack do
  let(:instance) { Akeyless::EventForwarderUpdateSlack.new }

  describe 'test an instance of EventForwarderUpdateSlack' do
    it 'should create an instance of EventForwarderUpdateSlack' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::EventForwarderUpdateSlack)
    end
  end
