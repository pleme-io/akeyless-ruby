...
# Unit tests for Akeyless::RotatedSecretUpdateSnowflake
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::RotatedSecretUpdateSnowflake do
  let(:instance) { Akeyless::RotatedSecretUpdateSnowflake.new }

  describe 'test an instance of RotatedSecretUpdateSnowflake' do
    it 'should create an instance of RotatedSecretUpdateSnowflake' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::RotatedSecretUpdateSnowflake)
    end
  end
