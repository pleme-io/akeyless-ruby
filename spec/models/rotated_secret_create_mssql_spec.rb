...
# Unit tests for Akeyless::RotatedSecretCreateMssql
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::RotatedSecretCreateMssql do
  let(:instance) { Akeyless::RotatedSecretCreateMssql.new }

  describe 'test an instance of RotatedSecretCreateMssql' do
    it 'should create an instance of RotatedSecretCreateMssql' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::RotatedSecretCreateMssql)
    end
  end
