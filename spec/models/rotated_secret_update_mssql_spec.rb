...
# Unit tests for Akeyless::RotatedSecretUpdateMssql
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::RotatedSecretUpdateMssql do
  let(:instance) { Akeyless::RotatedSecretUpdateMssql.new }

  describe 'test an instance of RotatedSecretUpdateMssql' do
    it 'should create an instance of RotatedSecretUpdateMssql' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::RotatedSecretUpdateMssql)
    end
  end
