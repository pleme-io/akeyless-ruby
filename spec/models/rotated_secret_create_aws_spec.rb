...
# Unit tests for Akeyless::RotatedSecretCreateAws
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::RotatedSecretCreateAws do
  let(:instance) { Akeyless::RotatedSecretCreateAws.new }

  describe 'test an instance of RotatedSecretCreateAws' do
    it 'should create an instance of RotatedSecretCreateAws' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::RotatedSecretCreateAws)
    end
  end
