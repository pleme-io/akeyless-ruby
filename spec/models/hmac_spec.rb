...
# Unit tests for Akeyless::Hmac
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::Hmac do
  let(:instance) { Akeyless::Hmac.new }

  describe 'test an instance of Hmac' do
    it 'should create an instance of Hmac' do
      expect(instance).to be_instance_of(Akeyless::Hmac)
    end
  end
