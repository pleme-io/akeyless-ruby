...
# Unit tests for Akeyless::RotatedSecretUpdateHanadb
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::RotatedSecretUpdateHanadb do
  let(:instance) { Akeyless::RotatedSecretUpdateHanadb.new }

  describe 'test an instance of RotatedSecretUpdateHanadb' do
    it 'should create an instance of RotatedSecretUpdateHanadb' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::RotatedSecretUpdateHanadb)
    end
  end
