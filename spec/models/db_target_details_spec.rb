...
# Unit tests for Akeyless::DbTargetDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::DbTargetDetails do
  let(:instance) { Akeyless::DbTargetDetails.new }

  describe 'test an instance of DbTargetDetails' do
    it 'should create an instance of DbTargetDetails' do
      expect(instance).to be_instance_of(Akeyless::DbTargetDetails)
    end
  end
