...
# Unit tests for Akeyless::RotatedSecretCreateMongodb
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::RotatedSecretCreateMongodb do
  let(:instance) { Akeyless::RotatedSecretCreateMongodb.new }

  describe 'test an instance of RotatedSecretCreateMongodb' do
    it 'should create an instance of RotatedSecretCreateMongodb' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::RotatedSecretCreateMongodb)
    end
  end
