...
# Unit tests for Akeyless::RotatedSecretUpdateRedshift
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::RotatedSecretUpdateRedshift do
  let(:instance) { Akeyless::RotatedSecretUpdateRedshift.new }

  describe 'test an instance of RotatedSecretUpdateRedshift' do
    it 'should create an instance of RotatedSecretUpdateRedshift' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::RotatedSecretUpdateRedshift)
    end
  end
