...
# Unit tests for Akeyless::AuthMethodCreateOIDC
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::AuthMethodCreateOIDC do
  let(:instance) { Akeyless::AuthMethodCreateOIDC.new }

  describe 'test an instance of AuthMethodCreateOIDC' do
    it 'should create an instance of AuthMethodCreateOIDC' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::AuthMethodCreateOIDC)
    end
  end
