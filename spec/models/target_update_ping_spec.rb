...
# Unit tests for Akeyless::TargetUpdatePing
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::TargetUpdatePing do
  let(:instance) { Akeyless::TargetUpdatePing.new }

  describe 'test an instance of TargetUpdatePing' do
    it 'should create an instance of TargetUpdatePing' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::TargetUpdatePing)
    end
  end
