...
module Akeyless
  ...
  class GetKubeExecCreds
    ...
    def hash
      [alt_names, api_version, cert_issuer_name, common_name, csr_data_base64, extended_key_usage, extra_extensions, json, key_data_base64, token, ttl, uid_token, uri_sans].hash
    end
