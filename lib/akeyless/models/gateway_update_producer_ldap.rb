...
module Akeyless
  ...
  class GatewayUpdateProducerLdap
    ...
    def hash
      [provider_type, bind_dn, bind_dn_password, delete_protection, external_username, group_dn, host_provider, json, ldap_ca_cert, ldap_url, name, new_name, password_length, producer_encryption_key_name, secure_access_enable, secure_access_host, secure_access_rd_gateway_server, secure_access_rdp_domain, tags, target, target_name, token, token_expiration, uid_token, user_attribute, user_dn, user_ttl].hash
    end
