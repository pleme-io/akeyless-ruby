...
module Akeyless
  ...
  class RotatedSecretDetailsInfo
    ...
    def hash
      [delete_previous_version_in_days, gw_cluster_id, last_rotation_error, number_of_versions_to_save, rotation_hour, rotation_interval_min, rotation_statement, rotator_creds_type, rotator_status, rotator_type, same_password, services_details].hash
    end
