...
module Akeyless
  class CreateDBTarget
    ...
    def hash
      [comment, db_name, db_server_certificates, db_server_name, db_type, host, key, mongodb_atlas, mongodb_atlas_api_private_key, mongodb_atlas_api_public_key, mongodb_atlas_project_id, mongodb_default_auth_db, mongodb_uri_options, name, oracle_service_name, port, pwd, snowflake_account, ssl, ssl_certificate, token, uid_token, user_name].hash
    end
