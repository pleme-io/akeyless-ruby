...
module Akeyless
  class RotatedSecretUpdateLdap
    ...
    def hash
      [provider_type, add_tag, authentication_credentials, auto_rotate, delete_protection, description, host_provider, json, keep_prev_version, key, name, new_name, password_length, rm_tag, rotate_after_disconnect, rotated_password, rotated_username, rotation_hour, rotation_interval, secure_access_enable, secure_access_host, secure_access_rdp_domain, secure_access_url, secure_access_web, target, token, uid_token, user_attribute, user_dn].hash
    end
