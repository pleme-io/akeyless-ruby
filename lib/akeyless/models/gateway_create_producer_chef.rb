...
module Akeyless
  ...
  class GatewayCreateProducerChef
    ...
    def hash
      [chef_orgs, chef_server_key, chef_server_url, chef_server_username, delete_protection, json, name, producer_encryption_key_name, skip_ssl, tags, target_name, token, uid_token, user_ttl].hash
    end
