...
module Akeyless
  class AkeylessGatewayConfig
    ...
    attr_accessor :config_protection_key_name
    ...
    attr_accessor :message_queue_info
    ...
    def self.openapi_types
      {
        ...
        :'cf' => :'CFConfigPart',
        :'config_protection_key_name' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Akeyless::AkeylessGatewayConfig` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Akeyless::AkeylessGatewayConfig`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'cf')
        self.cf = attributes[:'cf']
      end

      if attributes.key?(:'config_protection_key_name')
        self.config_protection_key_name = attributes[:'config_protection_key_name']
      end
      ...
      if attributes.key?(:'kerberos')
        self.kerberos = attributes[:'kerberos']
      end

      if attributes.key?(:'kmip_clients')
        self.kmip_clients = attributes[:'kmip_clients']
      end
      ...
      if attributes.key?(:'message_queue_info')
        self.message_queue_info = attributes[:'message_queue_info']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          cache == o.cache &&
          cf == o.cf &&
          config_protection_key_name == o.config_protection_key_name &&
          general == o.general &&
          k8s_auths == o.k8s_auths &&
          kerberos == o.kerberos &&
          kmip_clients == o.kmip_clients &&
          ldap == o.ldap &&
          leadership == o.leadership &&
          log_forwarding == o.log_forwarding &&
          message_queue_info == o.message_queue_info &&
    ...
    def hash
      [admins, cache, cf, config_protection_key_name, general, k8s_auths, kerberos, kmip_clients, ldap, leadership, log_forwarding, message_queue_info, migrations, producers, rotators, saml, version].hash
    end
