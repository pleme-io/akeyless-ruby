...
module Akeyless
  class AkeylessGatewayConfig
    ...
    def hash
      [admins, cache, cf, config_protection_key_name, general, k8s_auths, kmip_clients, ldap, leadership, log_forwarding, message_queue_info, migrations, producers, rotators, saml, version].hash
    end
