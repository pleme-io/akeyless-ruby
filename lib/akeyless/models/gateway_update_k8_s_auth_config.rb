...
module Akeyless
  ...
  class GatewayUpdateK8SAuthConfig
    ...
    def hash
      [access_id, cluster_api_type, config_encryption_key_name, json, k8s_ca_cert, k8s_host, k8s_issuer, name, new_name, rancher_api_key, rancher_cluster_id, signing_key, token, token_exp, token_reviewer_jwt, uid_token].hash
    end
