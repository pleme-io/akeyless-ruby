...
module Akeyless
  class UpdateGlobalSignAtlasTarget
    ...
    def hash
      [api_key, api_secret, comment, description, json, keep_prev_version, key, mtls_cert_data_base64, mtls_key_data_base64, name, new_name, timeout, token, uid_token, update_version].hash
    end
