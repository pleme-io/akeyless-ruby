...
module Akeyless
  class UpdateGlobalSignAtlasTarget
    ...
    attr_accessor :mtls_cert_data_base64
    ...
    attr_accessor :mtls_key_data_base64
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Akeyless::UpdateGlobalSignAtlasTarget` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Akeyless::UpdateGlobalSignAtlasTarget`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'mtls_cert_data_base64')
        self.mtls_cert_data_base64 = attributes[:'mtls_cert_data_base64']
      end

      if attributes.key?(:'mtls_key_data_base64')
        self.mtls_key_data_base64 = attributes[:'mtls_key_data_base64']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          mtls_cert_data_base64 == o.mtls_cert_data_base64 &&
          mtls_key_data_base64 == o.mtls_key_data_base64 &&
          name == o.name &&
          new_name == o.new_name &&
          timeout == o.timeout &&
          token == o.token &&
    ...
    def hash
      [api_key, api_secret, comment, description, json, keep_prev_version, key, max_versions, mtls_cert_data_base64, mtls_key_data_base64, name, new_name, timeout, token, uid_token, update_version].hash
    end
