...
module Akeyless
  ...
  class CreateAuthMethodOAuth2
    ...
    def hash
      [access_expires, audience, bound_client_ids, bound_ips, force_sub_claims, gw_bound_ips, issuer, json, jwks_uri, jwt_ttl, name, token, uid_token, unique_identifier].hash
    end
