...
module Akeyless
  ...
  class CreateAuthMethodOAuth2
    ...
    def hash
      [access_expires, audience, bound_client_ids, bound_ips, cert, cert_file_data, description, force_sub_claims, gateway_url, gw_bound_ips, issuer, json, jwks_json_data, jwks_uri, jwt_ttl, name, product_type, subclaims_delimiters, token, uid_token, unique_identifier].hash
    end
