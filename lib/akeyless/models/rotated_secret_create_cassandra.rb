...
module Akeyless
  class RotatedSecretCreateCassandra
    ...
    def hash
      [authentication_credentials, auto_rotate, delete_protection, description, json, key, name, password_length, rotated_password, rotated_username, rotation_hour, rotation_interval, rotator_type, tags, target_name, token, uid_token].hash
    end
