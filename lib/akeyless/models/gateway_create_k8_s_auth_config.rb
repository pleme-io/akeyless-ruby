...
module Akeyless
  ...
  class GatewayCreateK8SAuthConfig
    ...
    def hash
      [access_id, cluster_api_type, config_encryption_key_name, disable_issuer_validation, json, k8s_auth_type, k8s_ca_cert, k8s_client_certificate, k8s_client_key, k8s_host, k8s_issuer, name, rancher_api_key, rancher_cluster_id, signing_key, token, token_exp, token_reviewer_jwt, uid_token, use_gw_service_account].hash
    end
