...
module Akeyless
  class CreateGKETarget
    ...
    def hash
      [comment, gke_account_key, gke_cluster_cert, gke_cluster_endpoint, gke_cluster_name, gke_service_account_email, key, name, token, uid_token, use_gw_cloud_identity].hash
    end
