...
module Akeyless
  ...
  class CreateGKETarget
    ...
    def hash
      [comment, description, gke_account_key, gke_cluster_cert, gke_cluster_endpoint, gke_cluster_name, gke_service_account_email, json, key, max_versions, name, token, uid_token, use_gw_cloud_identity].hash
    end
