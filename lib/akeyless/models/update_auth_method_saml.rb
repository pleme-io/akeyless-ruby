...
module Akeyless
  ...
  class UpdateAuthMethodSAML
    ...
    def hash
      [access_expires, allowed_redirect_uri, bound_ips, force_sub_claims, gw_bound_ips, idp_metadata_url, idp_metadata_xml_data, jwt_ttl, name, new_name, token, uid_token, unique_identifier].hash
    end
