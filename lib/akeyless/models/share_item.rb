  ...
  class ShareItem
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'share_type')
        ...
        self.share_type = 'email'
      end

      if attributes.key?(:'shared_token_id')
        if (value = attributes[:'shared_token_id']).is_a?(Array)
          self.shared_token_id = value
        end
      end
    ...
    def hash
      [accessibility, action, emails, item_name, json, share_type, shared_token_id, token, ttl, uid_token, view_once].hash
    end
