...
module Akeyless
  class KerberosAuthMethodInfo
    ...
    attr_accessor :kerberos_krb5_conf
    ...
    attr_accessor :ldap_url_address
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Akeyless::KerberosAuthMethodInfo` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Akeyless::KerberosAuthMethodInfo`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'kerberos_krb5_conf')
        self.kerberos_krb5_conf = attributes[:'kerberos_krb5_conf']
      end
      ...
      if attributes.key?(:'ldap_url_address')
        self.ldap_url_address = attributes[:'ldap_url_address']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          kerberos_krb5_conf == o.kerberos_krb5_conf &&
          ...
          ldap_url_address == o.ldap_url_address &&
    ...
    def hash
      [kerberos_keytab, kerberos_krb5_conf, ldap_anonymous_search, ldap_bind_dn, ldap_bind_password, ldap_certificate, ldap_group_attr, ldap_group_dn, ldap_group_filter, ldap_url_address, ldap_user_attr, ldap_user_dn].hash
    end
