...
module Akeyless
  class UpdateGlobalSignTarget
    ...
    def hash
      [comment, contact_email, contact_first_name, contact_last_name, contact_phone, description, json, keep_prev_version, key, name, new_name, password, profile_id, timeout, token, uid_token, update_version, username].hash
    end
