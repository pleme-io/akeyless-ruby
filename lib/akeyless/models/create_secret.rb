...
module Akeyless
  class CreateSecret
    ...
    def hash
      [delete_protection, metadata, multiline_value, name, protection_key, secure_access_bastion_issuer, secure_access_enable, secure_access_host, secure_access_ssh_creds, secure_access_ssh_user, secure_access_url, secure_access_web_browsing, secure_access_web_proxy, tags, token, uid_token, value].hash
    end
