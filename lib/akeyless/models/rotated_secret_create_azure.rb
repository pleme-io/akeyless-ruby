...
module Akeyless
  class RotatedSecretCreateAzure
    ...
    def hash
      [api_id, api_key, application_id, authentication_credentials, auto_rotate, delete_protection, description, json, key, name, password_length, rotation_hour, rotation_interval, rotator_type, storage_account_key_name, tags, target_name, token, uid_token].hash
    end
