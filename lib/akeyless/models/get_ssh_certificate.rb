  ...
  class GetSSHCertificate
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Akeyless::GetSSHCertificate` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Akeyless::GetSSHCertificate`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'legacy_signing_alg_name')
        ...
        self.legacy_signing_alg_name = false
      end
    ...
    def list_invalid_properties
      ...
      if @cert_username.nil?
        invalid_properties.push('invalid value for "cert_username", cert_username cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @cert_username.nil?
      true
    end
    ...
    def hash
      [cert_issuer_name, cert_username, json, legacy_signing_alg_name, public_key_data, token, ttl, uid_token].hash
    end
