...
module Akeyless
  class GwClusterIdentity
    ...
    attr_accessor :current_gw

    # Deprecated - use CustomerFragments instead
    attr_accessor :customer_fragment_ids
    ...
    def hash
      [allowed, allowed_access_ids, cluster_name, cluster_url, current_gw, customer_fragment_ids, customer_fragments, default_protection_key_id, default_secret_location, display_name, id, status, status_description].hash
    end
