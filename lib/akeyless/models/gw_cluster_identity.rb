...
module Akeyless
  class GwClusterIdentity
    ...
    def hash
      [allowed, allowed_access_ids, cluster_name, cluster_url, current_gw, customer_fragment_ids, default_protection_key_id, default_secret_location, display_name, id, status, status_description].hash
    end
