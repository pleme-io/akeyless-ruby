...
module Akeyless
  ...
  class DynamicSecretUpdateOpenAI
    ...
    def hash
      [custom_username_template, delete_protection, description, item_custom_fields, json, name, new_name, producer_encryption_key_name, project_id, tags, target_name, token, uid_token, user_ttl].hash
    end
