...
module Akeyless
  class CreateNativeK8STarget
    ...
    def hash
      [comment, description, json, k8s_auth_type, k8s_client_certificate, k8s_client_key, k8s_cluster_ca_cert, k8s_cluster_endpoint, k8s_cluster_token, key, name, token, uid_token, use_gw_service_account].hash
    end
