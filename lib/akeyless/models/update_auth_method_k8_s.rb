...
module Akeyless
  ...
  class UpdateAuthMethodK8S
    ...
    def hash
      [access_expires, audience, bound_ips, bound_namespaces, bound_pod_names, bound_sa_names, description, force_sub_claims, gen_key, gw_bound_ips, json, jwt_ttl, name, new_name, product_type, public_key, token, uid_token].hash
    end
