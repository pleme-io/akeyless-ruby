...
module Akeyless
  ...
  class Connect
    ...
    def hash
      [helper, rc_file_override, bastion_ctrl_path, bastion_ctrl_port, bastion_ctrl_proto, bastion_ctrl_subdomain, cert_issuer_name, identity_file, name, ssh_extra_args, target, token, uid_token, via_bastion].hash
    end
