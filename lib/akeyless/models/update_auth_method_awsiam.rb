...
module Akeyless
  ...
  class UpdateAuthMethodAWSIAM
    ...
    def hash
      [access_expires, bound_arn, bound_aws_account_id, bound_ips, bound_resource_id, bound_role_id, bound_role_name, bound_user_id, bound_user_name, force_sub_claims, jwt_ttl, name, new_name, sts_url, token, uid_token].hash
    end
