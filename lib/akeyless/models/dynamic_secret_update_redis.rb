...
module Akeyless
  ...
  class DynamicSecretUpdateRedis
    ...
    def hash
      [acl_rules, custom_username_template, delete_protection, description, host, json, name, new_name, password, password_length, port, producer_encryption_key_name, ssl, ssl_certificate, tags, target_name, token, uid_token, user_ttl, username].hash
    end
