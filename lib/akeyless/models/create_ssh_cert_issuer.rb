...
module Akeyless
  class CreateSSHCertIssuer
    ...
    def hash
      [provider_type, allowed_users, delete_protection, description, extensions, host_provider, json, metadata, name, principals, secure_access_bastion_api, secure_access_bastion_ssh, secure_access_enable, secure_access_enforce_hosts_restriction, secure_access_host, secure_access_ssh_creds_user, secure_access_use_internal_bastion, signer_key_name, tag, target, token, ttl, uid_token].hash
    end
