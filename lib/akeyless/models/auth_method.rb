...
module Akeyless
  class AuthMethod
    ...
    attr_accessor :auth_method_additional_data
    ...
    def hash
      [access_date, access_date_display, access_info, account_id, associated_gw_ids, auth_method_access_id, auth_method_additional_data, auth_method_name, auth_method_roles_assoc, client_permissions, creation_date, delete_protection, description, expiration_events, is_approved, modification_date].hash
    end
