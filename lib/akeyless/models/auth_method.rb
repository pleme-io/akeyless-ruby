...
module Akeyless
  class AuthMethod
    ...
    def hash
      [access_date, access_info, account_id, auth_method_access_id, auth_method_name, auth_method_roles_assoc, client_permissions, creation_date, modification_date].hash
    end
