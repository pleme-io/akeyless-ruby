...
module Akeyless
  ...
  class EventForwarderCreateEmail
    ...
    def hash
      [auth_methods_event_source_locations, description, email_to, event_types, every, gateways_event_source_locations, items_event_source_locations, json, key, name, runner_type, targets_event_source_locations, token, uid_token].hash
    end
