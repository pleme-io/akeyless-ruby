...
module Akeyless
  class RotatedSecretCreateDockerhub
    ...
    def hash
      [authentication_credentials, auto_rotate, delete_protection, description, json, key, name, password_length, rotation_hour, rotation_interval, tags, target_name, token, uid_token].hash
    end
