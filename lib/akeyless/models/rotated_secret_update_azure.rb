...
module Akeyless
  class RotatedSecretUpdateAzure
    ...
    def hash
      [add_tag, api_id, api_key, application_id, authentication_credentials, auto_rotate, delete_protection, description, json, keep_prev_version, key, name, new_name, password_length, rm_tag, rotation_hour, rotation_interval, storage_account_key_name, token, uid_token].hash
    end
