...
module Akeyless
  class RotatedSecretCreateGcp
    ...
    def hash
      [authentication_credentials, auto_rotate, delete_protection, description, gcp_key, gcp_service_account_email, gcp_service_account_key_id, json, key, name, password_length, rotation_hour, rotation_interval, rotator_type, tags, target_name, token, uid_token].hash
    end
