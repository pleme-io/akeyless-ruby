...
module Akeyless
  class UpdateAWSTarget
    ...
    def hash
      [access_key, access_key_id, comment, description, json, keep_prev_version, key, max_versions, name, new_name, region, session_token, token, uid_token, update_version, use_gw_cloud_identity].hash
    end
