...
module Akeyless
  class Target
    ...
    attr_accessor :target_objects_assoc
    ...
    def self.openapi_types
      {
        ...
        :'target_name' => :'String',
        :'target_objects_assoc' => :'Array<TargetObjectAssociation>',
        :'target_type' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'target_objects_assoc')
        if (value = attributes[:'target_objects_assoc']).is_a?(Array)
          self.target_objects_assoc = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          target_objects_assoc == o.target_objects_assoc &&
    ...
    def hash
      [attributes, client_permissions, comment, last_version, protection_key_name, target_id, target_items_assoc, target_name, target_objects_assoc, target_type, target_versions, with_customer_fragment].hash
    end
