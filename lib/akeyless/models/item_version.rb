...
module Akeyless
  class ItemVersion
    ...
    def hash
      [access_date, creation_date, customer_fragment_id, deletion_date, item_version_state, modification_date, protection_key_name, version, with_customer_fragment].hash
    end
