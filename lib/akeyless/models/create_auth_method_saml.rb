...
module Akeyless
  ...
  class CreateAuthMethodSAML
    ...
    def hash
      [access_expires, allowed_redirect_uri, bound_ips, force_sub_claims, gw_bound_ips, idp_metadata_url, idp_metadata_xml_data, json, jwt_ttl, name, token, uid_token, unique_identifier].hash
    end
