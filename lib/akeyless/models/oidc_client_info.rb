...
module Akeyless
  class OidcClientInfo
    ...
    def self.openapi_types
      {
        :'access_permission_assignment' => :'Array<AccessOrGroupPermissionAssignment>',
    ...
    def hash
      [access_permission_assignment, audience, client_id, grant_types, issuer_url, logout_uris, public, redirect_uris, response_types, scopes].hash
    end
