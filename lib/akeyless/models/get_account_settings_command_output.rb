...
module Akeyless
  class GetAccountSettingsCommandOutput
    ...
    attr_accessor :secret_management

    attr_accessor :secure_remote_access

    attr_accessor :system_access_creds_settings
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Akeyless::GetAccountSettingsCommandOutput` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Akeyless::GetAccountSettingsCommandOutput`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'secret_management')
        self.secret_management = attributes[:'secret_management']
      end

      if attributes.key?(:'secure_remote_access')
        self.secure_remote_access = attributes[:'secure_remote_access']
      end

      if attributes.key?(:'system_access_creds_settings')
        self.system_access_creds_settings = attributes[:'system_access_creds_settings']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          secure_remote_access == o.secure_remote_access &&
          system_access_creds_settings == o.system_access_creds_settings
    end
