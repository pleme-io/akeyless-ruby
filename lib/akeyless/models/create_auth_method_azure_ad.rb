...
module Akeyless
  ...
  class CreateAuthMethodAzureAD
    ...
    def hash
      [access_expires, audience, bound_group_id, bound_ips, bound_providers, bound_resource_id, bound_resource_names, bound_resource_types, bound_rg_id, bound_spid, bound_sub_id, bound_tenant_id, force_sub_claims, issuer, jwks_uri, jwt_ttl, name, token, uid_token].hash
    end
