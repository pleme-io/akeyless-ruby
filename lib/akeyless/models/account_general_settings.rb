...
module Akeyless
  ...
  class AccountGeneralSettings
    ...
    def hash
      [account_default_key_item_id, account_default_key_name, data_protection_section, enable_request_for_access, invalid_characters, password_policy, protect_items_by_default, sharing_policy].hash
    end
