...
module Akeyless
  ...
  class AccountGeneralSettings
    ...
    def hash
      [account_default_key_item_id, account_default_key_name, auth_usage_event, data_protection_section, enable_request_for_access, invalid_characters, item_usage_event, lock_default_key, password_policy, protect_items_by_default, sharing_policy].hash
    end
