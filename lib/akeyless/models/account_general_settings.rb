...
module Akeyless
  ...
  class AccountGeneralSettings
    ...
    attr_accessor :certificate_expiration_events
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'allowed_gateways_ips')
        self.allowed_gateways_ips = attributes[:'allowed_gateways_ips']
      end
      ...
      if attributes.key?(:'certificate_expiration_events')
        self.certificate_expiration_events = attributes[:'certificate_expiration_events']
      end
      ...
      if attributes.key?(:'password_score')
