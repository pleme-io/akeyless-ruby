...
module Akeyless
  ...
  class EventForwarderUpdateEmail
    ...
    def hash
      [auth_methods_event_source_locations, description, email_to, enable, event_types, gateways_event_source_locations, items_event_source_locations, json, keep_prev_version, key, name, new_name, override_url, targets_event_source_locations, token, uid_token].hash
    end
