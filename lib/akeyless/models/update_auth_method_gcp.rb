...
module Akeyless
  ...
  class UpdateAuthMethodGCP
    ...
    def hash
      [access_expires, audience, bound_ips, bound_labels, bound_projects, bound_regions, bound_service_accounts, bound_zones, force_sub_claims, jwt_ttl, name, new_name, service_account_creds_data, token, type, uid_token].hash
    end
