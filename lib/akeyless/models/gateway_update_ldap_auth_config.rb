...
module Akeyless
  ...
  class GatewayUpdateLdapAuthConfig
    ...
    def hash
      [access_id, bind_dn, bind_dn_password, group_attr, group_dn, group_filter, ldap_ca_cert, ldap_enable, ldap_url, ldap_anonymous_search, signing_key_data, token, uid_token, user_attribute, user_dn].hash
    end
