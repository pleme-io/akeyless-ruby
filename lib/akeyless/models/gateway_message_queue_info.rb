...
module Akeyless
  class GatewayMessageQueueInfo
    attr_accessor :broadcast_queue_name_a
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'broadcast_queue_name_a')
        self.broadcast_queue_name_a = attributes[:'broadcast_queue_name_a']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          broadcast_queue_name_a == o.broadcast_queue_name_a &&
          mq_type == o.mq_type &&
    ...
    def hash
      [broadcast_queue_name_a, mq_type, queue_name, queue_url].hash
    end
