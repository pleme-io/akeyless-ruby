...
module Akeyless
  class ClientUsageInfo
    ...
    attr_accessor :exceeded_clients
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Akeyless::ClientUsageInfo` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Akeyless::ClientUsageInfo`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'exceeded_clients')
        self.exceeded_clients = attributes[:'exceeded_clients']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          exceeded_clients == o.exceeded_clients
    end
    ...
    def hash
      [access_id, access_type, auth_method_name, client_unique_id, exceeded_clients].hash
    end
