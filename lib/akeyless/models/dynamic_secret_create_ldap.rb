...
module Akeyless
  ...
  class DynamicSecretCreateLdap
    ...
    def hash
      [bind_dn, bind_dn_password, delete_protection, description, external_username, group_dn, json, ldap_ca_cert, ldap_url, name, password_length, producer_encryption_key_name, tags, target_name, token, token_expiration, uid_token, user_attribute, user_dn, user_ttl].hash
    end
