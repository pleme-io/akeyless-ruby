...
module Akeyless
  ...
  class UpdateAuthMethodUniversalIdentity
    ...
    def hash
      [access_expires, bound_ips, deny_inheritance, deny_rotate, description, force_sub_claims, gw_bound_ips, json, jwt_ttl, name, new_name, product_type, token, ttl, uid_token].hash
    end
