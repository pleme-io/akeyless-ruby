...
module Akeyless
  ...
  class DynamicSecretUpdateSnowflake
    ...
    def hash
      [account, account_password, account_username, db_name, delete_protection, description, json, name, new_name, password_length, private_key, private_key_passphrase, role, tags, target_name, token, uid_token, user_ttl, warehouse].hash
    end
