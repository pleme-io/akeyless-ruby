...
module Akeyless
  class TargetItemVersion
    ...
    def hash
      [creation_date, customer_fragment_id, deletion_date, item_version_state, latest_version, protection_key_name, target_name, version, with_customer_fragment].hash
    end
