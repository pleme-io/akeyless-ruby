...
module Akeyless
  class TargetItemVersion
    ...
    def hash
      [access_date, creation_date, customer_fragment_id, deletion_date, item_version_state, latest_version, modification_date, protection_key_name, target_name, version, with_customer_fragment].hash
    end
