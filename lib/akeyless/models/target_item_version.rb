...
module Akeyless
  class TargetItemVersion
    ...
    attr_accessor :item_version_state
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Akeyless::TargetItemVersion` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Akeyless::TargetItemVersion`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'item_version_state')
        self.item_version_state = attributes[:'item_version_state']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          item_version_state == o.item_version_state &&
    ...
    def hash
      [access_date, access_date_display, access_id, certificate_version_info, creation_date, customer_fragment_id, deletion_date, item_version_state, latest_version, modification_date, protection_key_name, target_name, unique_identifier, version, with_customer_fragment].hash
    end
