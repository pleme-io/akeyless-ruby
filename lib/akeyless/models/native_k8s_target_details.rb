...
module Akeyless
  class NativeK8sTargetDetails
    ...
    def hash
      [k8s_auth_type, k8s_bearer_token, k8s_client_cert_data, k8s_client_key_data, k8s_cluster_ca_certificate, k8s_cluster_endpoint, k8s_cluster_name, use_gw_service_account].hash
    end
