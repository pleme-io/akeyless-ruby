...
module Akeyless
  class StaticSecretDetailsInfo
    ...
    attr_accessor :password_security_info
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Akeyless::StaticSecretDetailsInfo` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Akeyless::StaticSecretDetailsInfo`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'password_security_info')
        self.password_security_info = attributes[:'password_security_info']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          password_security_info == o.password_security_info &&
          username == o.username &&
          website == o.website &&
          websites == o.websites
    end
