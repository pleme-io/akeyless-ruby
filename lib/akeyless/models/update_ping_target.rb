...
module Akeyless
  ...
  class UpdatePingTarget
    ...
    def hash
      [administrative_port, authorization_port, comment, description, json, keep_prev_version, key, max_versions, name, new_name, password, ping_url, privileged_user, token, uid_token, update_version].hash
    end
