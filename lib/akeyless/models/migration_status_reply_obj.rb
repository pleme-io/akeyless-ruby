...
module Akeyless
  class MigrationStatusReplyObj
    ...
    def hash
      [duration_time, error, last_status_message, max_name_length, max_value_length, migration_id, migration_items, migration_name, migration_state, migration_type, migration_type_name, rotated_secrets, start_time, targets].hash
    end
