...
module Akeyless
  class GetCertificateValue
    ...
    attr_accessor :certificate_file_output
    ...
    attr_accessor :private_key_file_output
    ...
    def self.openapi_types
      {
        ...
        :'certificate_file_output' => :'String',
        :'display_id' => :'String',
        :'ignore_cache' => :'String',
        :'issuance_token' => :'String',
        :'json' => :'Boolean',
        :'name' => :'String',
        :'private_key_file_output' => :'String',
        :'token' => :'String',
        :'uid_token' => :'String',
        :'version' => :'Integer'
      }
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'certificate_file_output')
        self.certificate_file_output = attributes[:'certificate_file_output']
      end
      ...
      if attributes.key?(:'issuance_token')
        self.issuance_token = attributes[:'issuance_token']
      end
      ...
      if attributes.key?(:'name')
        ...
        self.name = 'dummy_certificate_name'
      end

      if attributes.key?(:'private_key_file_output')
        self.private_key_file_output = attributes[:'private_key_file_output']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          certificate_file_output == o.certificate_file_output &&
          display_id == o.display_id &&
          ignore_cache == o.ignore_cache &&
          issuance_token == o.issuance_token &&
          json == o.json &&
          name == o.name &&
          private_key_file_output == o.private_key_file_output &&
          token == o.token &&
    ...
    def hash
      [cert_issuer_name, certificate_file_output, display_id, ignore_cache, issuance_token, json, name, private_key_file_output, token, uid_token, version].hash
    end
