...
module Akeyless
  class ExportClassicKeyOutput
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'wrapping_iv')
        self.wrapping_iv = attributes[:'wrapping_iv']
      end
    end
    ...
    def hash
      [certificate_pem, key, ssh, wrapping_iv].hash
    end
