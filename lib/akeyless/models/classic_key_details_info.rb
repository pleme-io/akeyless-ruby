...
module Akeyless
  class ClassicKeyDetailsInfo
    ...
    def hash
      [classic_key_attributes, classic_key_id, gw_cluster_id, is_provided_by_user, is_unexportable, key_state, key_type, last_error, target_alias_helper, target_types, targets].hash
    end
