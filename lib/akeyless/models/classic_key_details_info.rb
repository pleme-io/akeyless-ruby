...
module Akeyless
  class ClassicKeyDetailsInfo
    ...
    def hash
      [classic_key_attributes, classic_key_id, credential_id, gw_cluster_id, has_certificate, is_provided_by_user, is_unexportable, key_state, key_type, last_error, public_key, target_alias_helper, target_types, targets, username, websites].hash
    end
