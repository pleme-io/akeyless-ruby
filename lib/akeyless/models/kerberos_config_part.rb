...
module Akeyless
  class KerberosConfigPart
    attr_accessor :kerberos_access_id

    attr_accessor :kerberos_keytab

    attr_accessor :kerberos_krb_5_conf

    attr_accessor :kerberos_private_key
    ...
    def self.openapi_types
      {
        :'kerberos_access_id' => :'String',
        :'kerberos_keytab' => :'String',
        :'kerberos_krb_5_conf' => :'String',
        :'kerberos_private_key' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Akeyless::KerberosConfigPart` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Akeyless::KerberosConfigPart`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'kerberos_access_id')
        self.kerberos_access_id = attributes[:'kerberos_access_id']
      end

      if attributes.key?(:'kerberos_keytab')
        self.kerberos_keytab = attributes[:'kerberos_keytab']
      end

      if attributes.key?(:'kerberos_krb_5_conf')
        self.kerberos_krb_5_conf = attributes[:'kerberos_krb_5_conf']
      end

      if attributes.key?(:'kerberos_private_key')
        self.kerberos_private_key = attributes[:'kerberos_private_key']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          kerberos_access_id == o.kerberos_access_id &&
          kerberos_keytab == o.kerberos_keytab &&
          kerberos_krb_5_conf == o.kerberos_krb_5_conf &&
          kerberos_private_key == o.kerberos_private_key &&
    ...
    def hash
      [kerberos_access_id, kerberos_keytab, kerberos_krb_5_conf, kerberos_private_key, ldap_anonymous_search, ldap_bind_dn, ldap_bind_password, ldap_cert, ldap_group_attr, ldap_group_dn, ldap_group_filter, ldap_url, ldap_user_attr, ldap_user_dn].hash
    end
