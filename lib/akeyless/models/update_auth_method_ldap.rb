...
module Akeyless
  ...
  class UpdateAuthMethodLDAP
    ...
    def hash
      [access_expires, bound_ips, description, force_sub_claims, gen_key, gw_bound_ips, json, jwt_ttl, name, new_name, product_type, public_key_data, token, uid_token, unique_identifier].hash
    end
