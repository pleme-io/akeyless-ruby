...
module Akeyless
  class UpdateOidcApp
    ...
    attr_accessor :permission_assignment
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Akeyless::UpdateOidcApp` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Akeyless::UpdateOidcApp`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'permission_assignment')
        self.permission_assignment = attributes[:'permission_assignment']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          key == o.key &&
          name == o.name &&
          permission_assignment == o.permission_assignment &&
          public == o.public &&
    ...
    def hash
      [audience, json, key, name, permission_assignment, public, redirect_uris, scopes, token, uid_token].hash
    end
