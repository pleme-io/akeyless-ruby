...
module Akeyless
  class UpdateSSHTarget
    ...
    def hash
      [description, host, json, keep_prev_version, key, name, new_name, port, private_key, private_key_password, ssh_password, ssh_username, token, uid_token, update_version].hash
    end
