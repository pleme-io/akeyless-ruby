...
module Akeyless
  ...
  class ExportClassicKey
    ...
    attr_accessor :export_public_key
    ...
    attr_accessor :wrapping_key_name
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'export_public_key')
        self.export_public_key = attributes[:'export_public_key']
      else
        self.export_public_key = false
      end
      ...
      if attributes.key?(:'wrapping_key_name')
        self.wrapping_key_name = attributes[:'wrapping_key_name']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          export_public_key == o.export_public_key &&
          ...
          version == o.version &&
          wrapping_key_name == o.wrapping_key_name
    end
    ...
    def hash
      [accessibility, export_public_key, ignore_cache, json, name, token, uid_token, version, wrapping_key_name].hash
    end
