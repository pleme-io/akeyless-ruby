...
module Akeyless
  ...
  class DynamicSecretUpdateOracleDb
    ...
    def hash
      [custom_username_template, db_server_certificates, db_server_name, delete_protection, description, json, name, new_name, oracle_host, oracle_password, oracle_port, oracle_revocation_statements, oracle_screation_statements, oracle_service_name, oracle_username, password_length, producer_encryption_key_name, secure_access_bastion_issuer, secure_access_certificate_issuer, secure_access_enable, secure_access_host, secure_access_web, tags, target_name, token, uid_token, user_ttl].hash
    end
