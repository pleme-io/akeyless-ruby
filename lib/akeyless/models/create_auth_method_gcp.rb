...
module Akeyless
  ...
  class CreateAuthMethodGCP
    ...
    def hash
      [access_expires, audience, bound_ips, bound_labels, bound_projects, bound_regions, bound_service_accounts, bound_zones, force_sub_claims, gw_bound_ips, jwt_ttl, name, service_account_creds_data, token, type, uid_token].hash
    end
