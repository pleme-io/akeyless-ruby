...
module Akeyless
  ...
  class CreateAuthMethodK8S
    ...
    def hash
      [access_expires, audience, bound_ips, bound_namespaces, bound_pod_names, bound_sa_names, force_sub_claims, gen_key, gw_bound_ips, jwt_ttl, name, public_key, token, uid_token].hash
    end
