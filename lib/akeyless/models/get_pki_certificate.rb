...
module Akeyless
  class GetPKICertificate
    ...
    def hash
      [alt_names, cert_issuer_name, common_name, csr_data_base64, extended_key_usage, extra_extensions, json, key_data_base64, max_path_len, token, ttl, uid_token, uri_sans].hash
    end
