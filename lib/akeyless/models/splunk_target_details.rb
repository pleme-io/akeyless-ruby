  ...
  class SplunkTargetDetails
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Akeyless::SplunkTargetDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Akeyless::SplunkTargetDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'splunk_payload')
        self.splunk_payload = attributes[:'splunk_payload']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          password == o.password &&
          splunk_payload == o.splunk_payload &&
    ...
    def hash
      [audience, auth_mode, password, splunk_payload, splunk_url, token, token_owner, use_tls, username].hash
    end
