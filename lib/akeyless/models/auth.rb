...
module Akeyless
  class Auth
    ...
    def hash
      [access_id, access_key, access_type, account_id, admin_email, admin_password, cert_data, cloud_id, debug, disable_pafxfast, gateway_spn, gateway_url, gcp_audience, json, jwt, k8s_auth_config_name, k8s_service_account_token, kerberos_username, key_data, keytab_data, krb5_conf_data, ldap_password, ldap_username, oci_auth_type, oci_group_ocid, uid_token, use_remote_browser].hash
    end
