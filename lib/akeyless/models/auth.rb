...
module Akeyless
  class Auth
    ...
    def hash
      [access_id, access_key, access_type, admin_email, admin_password, cert_data, cloud_id, debug, gcp_audience, json, jwt, k8s_auth_config_name, k8s_service_account_token, key_data, ldap_password, ldap_username, uid_token].hash
    end
