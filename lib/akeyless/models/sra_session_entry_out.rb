...
module Akeyless
  class SraSessionEntryOut
    ...
    def hash
      [access_id, client_type, cluster_unique_id, connection_type, end_time, error_msg, gateway_name, instance_id, secret_name, session_id, start_time, status, target_host, ttl, user_identifier].hash
    end
