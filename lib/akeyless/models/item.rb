...
module Akeyless
  class Item
    ...
    attr_accessor :usc_sync_associated_items
    ...
    def self.openapi_types
      {
        ...
        :'usc_sync_associated_items' => :'Array<ItemUSCSyncAssociation>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'usc_sync_associated_items')
        if (value = attributes[:'usc_sync_associated_items']).is_a?(Array)
          self.usc_sync_associated_items = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          usc_sync_associated_items == o.usc_sync_associated_items &&
