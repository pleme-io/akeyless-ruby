...
module Akeyless
  ...
  class DynamicSecretCreateGitlab
    ...
    attr_accessor :gitlab_token_scopes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Akeyless::DynamicSecretCreateGitlab` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Akeyless::DynamicSecretCreateGitlab`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'gitlab_token_scopes')
        self.gitlab_token_scopes = attributes[:'gitlab_token_scopes']
      else
        self.gitlab_token_scopes = nil
      end
    ...
    def list_invalid_properties
      ...
      if @gitlab_access_type.nil?
        invalid_properties.push('invalid value for "gitlab_access_type", gitlab_access_type cannot be nil.')
      end

      if @gitlab_token_scopes.nil?
        invalid_properties.push('invalid value for "gitlab_token_scopes", gitlab_token_scopes cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @gitlab_access_type.nil?
      return false if @gitlab_token_scopes.nil?
