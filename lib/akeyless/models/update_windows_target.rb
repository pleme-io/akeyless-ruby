...
module Akeyless
  ...
  class UpdateWindowsTarget
    ...
    def hash
      [certificate, connection_type, description, domain, hostname, json, keep_prev_version, key, max_versions, name, new_name, parent_target_name, password, port, token, uid_token, update_version, use_tls, username].hash
    end
