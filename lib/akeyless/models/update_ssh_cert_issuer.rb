...
module Akeyless
  class UpdateSSHCertIssuer
    ...
    def hash
      [provider_type, add_tag, allowed_users, delete_protection, description, extensions, external_username, fixed_user_claim_keyname, host_provider, json, metadata, name, new_name, principals, rm_tag, secure_access_api, secure_access_bastion_api, secure_access_bastion_ssh, secure_access_enable, secure_access_enforce_hosts_restriction, secure_access_host, secure_access_ssh, secure_access_ssh_creds_user, secure_access_use_internal_bastion, secure_access_use_internal_ssh_access, signer_key_name, token, ttl, uid_token].hash
    end
