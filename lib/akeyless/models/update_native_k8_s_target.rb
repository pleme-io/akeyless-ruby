...
module Akeyless
  class UpdateNativeK8STarget
    ...
    def hash
      [comment, description, json, k8s_cluster_ca_cert, k8s_cluster_endpoint, k8s_cluster_token, keep_prev_version, key, name, new_name, token, uid_token, update_version, use_gw_service_account].hash
    end
