...
module Akeyless
  ...
  class UpdateAuthMethodOAuth2
    ...
    def hash
      [access_expires, audience, bound_client_ids, bound_ips, force_sub_claims, gw_bound_ips, issuer, jwks_uri, jwt_ttl, name, new_name, token, uid_token, unique_identifier].hash
    end
