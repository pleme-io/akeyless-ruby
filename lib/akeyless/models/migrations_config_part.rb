...
module Akeyless
  class MigrationsConfigPart
    ...
    def hash
      [active_directory_migrations, aws_secrets_migrations, azure_kv_migrations, gcp_secrets_migrations, hashi_migrations, k8s_migrations, one_password_migrations].hash
    end
