...
module Akeyless
  class RotatedSecretUpdateDockerhub
    ...
    def hash
      [add_tag, authentication_credentials, auto_rotate, delete_protection, description, json, keep_prev_version, key, name, new_name, password_length, rm_tag, rotation_hour, rotation_interval, token, uid_token].hash
    end
