...
module Akeyless
  ...
  class UpdateAuthMethodCert
    ...
    def hash
      [access_expires, bound_common_names, bound_dns_sans, bound_email_sans, bound_extensions, bound_ips, bound_organizational_units, bound_uri_sans, certificate_data, force_sub_claims, gw_bound_ips, jwt_ttl, name, new_name, revoked_cert_ids, token, uid_token, unique_identifier].hash
    end
