...
module Akeyless
  ...
  class DynamicSecretUpdateGoogleWorkspace
    ...
    def hash
      [access_mode, admin_email, delete_protection, description, gcp_key, group_email, group_role, json, name, new_name, producer_encryption_key_name, role_name, role_scope, secure_access_enable, secure_access_url, secure_access_web, secure_access_web_browsing, secure_access_web_proxy, tags, target_name, token, uid_token, user_ttl].hash
    end
