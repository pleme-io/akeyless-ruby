...
module Akeyless
  ...
  class DynamicSecretUpdateGoogleWorkspace
    ...
    def hash
      [access_mode, admin_email, delete_protection, description, gcp_key, group_email, group_role, json, name, new_name, producer_encryption_key_name, role_name, role_scope, tags, target_name, token, uid_token, user_ttl].hash
    end
