...
module Akeyless
  ...
  class UpdateAuthMethodOIDC
    ...
    def hash
      [access_expires, allowed_redirect_uri, bound_ips, client_id, client_secret, force_sub_claims, gw_bound_ips, issuer, jwt_ttl, name, new_name, required_scopes, required_scopes_prefix, token, uid_token, unique_identifier].hash
    end
