...
require 'akeyless/models/aws_gateway_cloud_identity_external_id_opt'
...
require 'akeyless/models/auth_expiration_event'
require 'akeyless/models/auth_method'
require 'akeyless/models/auth_method_access_info'
require 'akeyless/models/auth_method_additional_data'
require 'akeyless/models/auth_method_create_api_key'
require 'akeyless/models/auth_method_create_aws_iam'
require 'akeyless/models/auth_method_create_azure_ad'
require 'akeyless/models/auth_method_create_cert'
require 'akeyless/models/auth_method_create_email'
require 'akeyless/models/auth_method_create_gcp'
require 'akeyless/models/auth_method_create_k8s'
require 'akeyless/models/auth_method_create_kerberos'
require 'akeyless/models/auth_method_create_ldap'
require 'akeyless/models/auth_method_create_oci'
require 'akeyless/models/auth_method_create_oidc'
require 'akeyless/models/auth_method_create_oauth2'
require 'akeyless/models/auth_method_create_output'
require 'akeyless/models/auth_method_create_saml'
require 'akeyless/models/auth_method_create_universal_identity'
require 'akeyless/models/auth_method_delete'
require 'akeyless/models/auth_method_delete_output'
require 'akeyless/models/auth_method_get'
require 'akeyless/models/auth_method_list'
require 'akeyless/models/auth_method_role_association'
require 'akeyless/models/auth_method_update_api_key'
require 'akeyless/models/auth_method_update_aws_iam'
require 'akeyless/models/auth_method_update_azure_ad'
require 'akeyless/models/auth_method_update_cert'
require 'akeyless/models/auth_method_update_email'
require 'akeyless/models/auth_method_update_gcp'
require 'akeyless/models/auth_method_update_k8s'
require 'akeyless/models/auth_method_update_kerberos'
require 'akeyless/models/auth_method_update_ldap'
require 'akeyless/models/auth_method_update_oci'
require 'akeyless/models/auth_method_update_oidc'
require 'akeyless/models/auth_method_update_oauth2'
require 'akeyless/models/auth_method_update_output'
require 'akeyless/models/auth_method_update_saml'
require 'akeyless/models/auth_method_update_universal_identity'
require 'akeyless/models/auth_output'
require 'akeyless/models/aws_s3_log_forwarding_config'
require 'akeyless/models/aws_storage'
...
require 'akeyless/models/azure_storage'
require 'akeyless/models/azure_target_details'
require 'akeyless/models/bastion_config_reply_obj'
require 'akeyless/models/bastion_global_conf'
...
require 'akeyless/models/calc_password_security_info'
...
require 'akeyless/models/client_usage_info'
require 'akeyless/models/clients_usage_report'
...
require 'akeyless/models/create_auth_method_oci'
require 'akeyless/models/create_auth_method_oci_output'
...
require 'akeyless/models/create_gitlab_target'
require 'akeyless/models/create_gitlab_target_output'
require 'akeyless/models/create_global_sign_atlas_target'
require 'akeyless/models/create_global_sign_atlas_target_output'
require 'akeyless/models/create_global_sign_target'
require 'akeyless/models/create_global_sign_target_output'
require 'akeyless/models/create_godaddy_target'
require 'akeyless/models/create_godaddy_target_output'
require 'akeyless/models/create_group'
require 'akeyless/models/create_group_output'
require 'akeyless/models/create_hashi_vault_target'
require 'akeyless/models/create_hashi_vault_target_output'
...
require 'akeyless/models/create_oidc_app_output'
require 'akeyless/models/create_pki_cert_issuer'
require 'akeyless/models/create_pki_cert_issuer_output'
require 'akeyless/models/create_passkey'
require 'akeyless/models/create_passkey_output'
...
require 'akeyless/models/create_usc'
require 'akeyless/models/create_usc_output'
require 'akeyless/models/create_user_event'
require 'akeyless/models/create_user_event_output'
require 'akeyless/models/create_web_target'
require 'akeyless/models/create_web_target_output'
require 'akeyless/models/create_windows_target'
...
require 'akeyless/models/delete_gateway_allowed_access_id'
require 'akeyless/models/delete_group'
require 'akeyless/models/delete_group_output'
require 'akeyless/models/delete_gw_cluster'
...
require 'akeyless/models/dynamic_secret_create_azure'
require 'akeyless/models/dynamic_secret_create_cassandra'
require 'akeyless/models/dynamic_secret_create_chef'
require 'akeyless/models/dynamic_secret_create_custom'
require 'akeyless/models/dynamic_secret_create_dockerhub'
require 'akeyless/models/dynamic_secret_create_eks'
require 'akeyless/models/dynamic_secret_create_gcp'
require 'akeyless/models/dynamic_secret_create_github'
require 'akeyless/models/dynamic_secret_create_gitlab'
require 'akeyless/models/dynamic_secret_create_gke'
require 'akeyless/models/dynamic_secret_create_google_workspace'
require 'akeyless/models/dynamic_secret_create_hana_db'
require 'akeyless/models/dynamic_secret_create_k8s'
require 'akeyless/models/dynamic_secret_create_ldap'
...
require 'akeyless/models/dynamic_secret_create_postgre_sql'
require 'akeyless/models/dynamic_secret_create_rabbit_mq'
require 'akeyless/models/dynamic_secret_create_rdp'
require 'akeyless/models/dynamic_secret_create_redis'
require 'akeyless/models/dynamic_secret_create_redshift'
require 'akeyless/models/dynamic_secret_create_snowflake'
require 'akeyless/models/dynamic_secret_create_venafi'
require 'akeyless/models/dynamic_secret_delete'
require 'akeyless/models/dynamic_secret_delete_output'
require 'akeyless/models/dynamic_secret_get'
require 'akeyless/models/dynamic_secret_get_value'
require 'akeyless/models/dynamic_secret_list'
require 'akeyless/models/dynamic_secret_max_ttl'
require 'akeyless/models/dynamic_secret_producer_info'
require 'akeyless/models/dynamic_secret_tmp_creds_delete'
require 'akeyless/models/dynamic_secret_tmp_creds_get'
require 'akeyless/models/dynamic_secret_tmp_creds_update'
require 'akeyless/models/dynamic_secret_update_artifactory'
require 'akeyless/models/dynamic_secret_update_aws'
require 'akeyless/models/dynamic_secret_update_azure'
require 'akeyless/models/dynamic_secret_update_cassandra'
require 'akeyless/models/dynamic_secret_update_chef'
require 'akeyless/models/dynamic_secret_update_custom'
require 'akeyless/models/dynamic_secret_update_dockerhub'
require 'akeyless/models/dynamic_secret_update_eks'
require 'akeyless/models/dynamic_secret_update_gcp'
require 'akeyless/models/dynamic_secret_update_github'
require 'akeyless/models/dynamic_secret_update_gitlab'
require 'akeyless/models/dynamic_secret_update_gke'
require 'akeyless/models/dynamic_secret_update_google_workspace'
require 'akeyless/models/dynamic_secret_update_hana_db'
require 'akeyless/models/dynamic_secret_update_k8s'
require 'akeyless/models/dynamic_secret_update_ldap'
...
require 'akeyless/models/dynamic_secret_update_postgre_sql'
require 'akeyless/models/dynamic_secret_update_rabbit_mq'
require 'akeyless/models/dynamic_secret_update_rdp'
require 'akeyless/models/dynamic_secret_update_redis'
require 'akeyless/models/dynamic_secret_update_redshift'
require 'akeyless/models/dynamic_secret_update_snowflake'
...
require 'akeyless/models/event_forwarder_delete_output'
require 'akeyless/models/event_forwarder_get'
require 'akeyless/models/event_forwarder_get_output'
...
require 'akeyless/models/gateway_create_producer_google_workspace_output'
...
require 'akeyless/models/gateway_create_producer_venafi'
require 'akeyless/models/gateway_create_producer_venafi_output'
...
require 'akeyless/models/gateway_get_cache'
require 'akeyless/models/gateway_get_config'
require 'akeyless/models/gateway_get_defaults'
require 'akeyless/models/gateway_get_defaults_output'
...
require 'akeyless/models/gateway_name_info'
require 'akeyless/models/gateway_partial_update_k8_s_auth_config'
require 'akeyless/models/gateway_partial_update_k8_s_auth_config_output'
...
require 'akeyless/models/gateway_update_cache'
require 'akeyless/models/gateway_update_defaults'
...
require 'akeyless/models/gateway_update_log_forwarding_aws_s3'
require 'akeyless/models/gateway_update_log_forwarding_azure_analytics'
require 'akeyless/models/gateway_update_log_forwarding_datadog'
require 'akeyless/models/gateway_update_log_forwarding_elasticsearch'
require 'akeyless/models/gateway_update_log_forwarding_google_chronicle'
require 'akeyless/models/gateway_update_log_forwarding_logstash'
require 'akeyless/models/gateway_update_log_forwarding_logz_io'
require 'akeyless/models/gateway_update_log_forwarding_output'
require 'akeyless/models/gateway_update_log_forwarding_splunk'
require 'akeyless/models/gateway_update_log_forwarding_stdout'
require 'akeyless/models/gateway_update_log_forwarding_sumologic'
require 'akeyless/models/gateway_update_log_forwarding_syslog'
require 'akeyless/models/gateway_update_migration'
require 'akeyless/models/gateway_update_output'
...
require 'akeyless/models/generate_ca'
require 'akeyless/models/generate_ca_output'
...
require 'akeyless/models/get_last_user_event_status'
...
require 'akeyless/models/gw_update_remote_access_session_logs_azure_analytics'
require 'akeyless/models/gw_update_remote_access_session_logs_datadog'
require 'akeyless/models/gw_update_remote_access_session_logs_elasticsearch'
require 'akeyless/models/gw_update_remote_access_session_logs_google_chronicle'
require 'akeyless/models/gw_update_remote_access_session_logs_logstash'
...
require 'akeyless/models/hmac'
require 'akeyless/models/hmac_output'
...
require 'akeyless/models/kubeconfig_exec'
require 'akeyless/models/kubeconfig_generate_output'
require 'akeyless/models/kubeconfig_named_cluster'
require 'akeyless/models/kubeconfig_named_context'
require 'akeyless/models/kubeconfig_user'
require 'akeyless/models/kubeconfig_user_exec'
...
require 'akeyless/models/mongo_db_target_details'
...
require 'akeyless/models/password_score_info'
...
require 'akeyless/models/reset_access_key'
require 'akeyless/models/reset_auth_method_access_key_output'
require 'akeyless/models/response_stop_share_item'
...
require 'akeyless/models/revoke_certificate'
...
require 'akeyless/models/rotate_oidc_client_output'
require 'akeyless/models/rotate_oidc_client_secret'
require 'akeyless/models/rotate_secret'
require 'akeyless/models/rotated_secret_create_aws'
require 'akeyless/models/rotated_secret_create_azure'
require 'akeyless/models/rotated_secret_create_cassandra'
require 'akeyless/models/rotated_secret_create_custom'
...
require 'akeyless/models/rotated_secret_delete_sync'
require 'akeyless/models/rotated_secret_delete_sync_output'
require 'akeyless/models/rotated_secret_details_info'
require 'akeyless/models/rotated_secret_get_value'
require 'akeyless/models/rotated_secret_list'
require 'akeyless/models/rotated_secret_output'
require 'akeyless/models/rotated_secret_sync'
require 'akeyless/models/rotated_secret_update_aws'
require 'akeyless/models/rotated_secret_update_azure'
require 'akeyless/models/rotated_secret_update_cassandra'
require 'akeyless/models/rotated_secret_update_custom'
...
require 'akeyless/models/share_item_output'
require 'akeyless/models/sharing_item_full_info'
require 'akeyless/models/sharing_policy_info'
require 'akeyless/models/sign_data_with_classic_key'
require 'akeyless/models/sign_ec_dsa'
require 'akeyless/models/sign_ec_dsa_output'
...
require 'akeyless/models/ssh_bastion_session_termination'
require 'akeyless/models/static_creds_auth'
require 'akeyless/models/static_creds_auth_output'
require 'akeyless/models/static_secret_delete_sync'
require 'akeyless/models/static_secret_delete_sync_output'
...
require 'akeyless/models/target_update_salesforce'
require 'akeyless/models/target_update_sectigo'
require 'akeyless/models/target_update_ssh'
...
require 'akeyless/models/update_auth_method_oci'
require 'akeyless/models/update_auth_method_oci_output'
...
require 'akeyless/models/update_gitlab_target'
require 'akeyless/models/update_gitlab_target_output'
require 'akeyless/models/update_global_sign_atlas_target'
require 'akeyless/models/update_global_sign_atlas_target_output'
require 'akeyless/models/update_global_sign_target'
require 'akeyless/models/update_global_sign_target_output'
require 'akeyless/models/update_godaddy_target'
require 'akeyless/models/update_godaddy_target_output'
require 'akeyless/models/update_group'
require 'akeyless/models/update_group_output'
require 'akeyless/models/update_hashi_vault_target'
require 'akeyless/models/update_hashi_vault_target_output'
...
require 'akeyless/models/update_windows_target'
require 'akeyless/models/update_zero_ssl_target'
require 'akeyless/models/update_zero_ssl_target_output'
require 'akeyless/models/upload_pkcs12'
require 'akeyless/models/upload_rsa'
require 'akeyless/models/usage_event_setting'
require 'akeyless/models/usage_report_summary'
require 'akeyless/models/usc_create'
require 'akeyless/models/usc_create_secret_output'
require 'akeyless/models/usc_delete'
require 'akeyless/models/usc_delete_secret_output'
require 'akeyless/models/usc_get'
require 'akeyless/models/usc_get_secret_output'
require 'akeyless/models/usc_list'
require 'akeyless/models/usc_list_secrets_output'
...
require 'akeyless/models/verify_ec_dsa'
...
require 'akeyless/models/verify_rsa_ssa_pss'
require 'akeyless/models/wallet_details'
require 'akeyless/models/web_bastion_conf'
require 'akeyless/models/web_bastion_guacamole'
...
require 'akeyless/models/zero_ssl_target_details'
